            ...
            <div class="col-lg-4 m-15px-tb blog-aside">
              ...
              <div class="widget widget-author">
                <div class="widget-title">
                  <h3>You Interested ?</h3>
                </div>
                <div class="widget-body">
                  <a
                    class="btn btn-primary w-100"
                    href="mailto:info@trees4trees.org"
                    >Apply Job</a
                  >
                  <a
                    class="btn btn-primary w-100 mt-3"
                    v-if="items.file_job_vacancies"
                    :href="items.file_job_vacancies.url"
                    target="_blank"
                    >Download File</a
                  >
                </div>
...
export default {
  ...
  methods: {
    async getJob() {
        await this.$_api.get("public/job-vacancy/" + this.$route.params.id).then(res => {
            this.items = res.data
        })
    }
  },
