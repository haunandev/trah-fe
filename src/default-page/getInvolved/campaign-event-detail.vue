            ...
            <div class="col-lg-8 m-15px-tb">
              <article class="article">
                <div class="article-img">
                  <img
                    v-if="items.file_event"
                    class="resize-img-850"
                    :src="items.file_event.url"
                    :title="items.file_event.filename"
                    :alt="items.file_event.filename"
                  />
                </div>
                <div class="article-title">
                  <h6>
                    <a href="#">{{ items.rel_category_event_id }}</a>
                  </h6>
...
export default {
  ...
  methods: {
    async getNewsDetail() {
        await this.$_api.get("public/event/" + this.$route.params.id).then(res => {
            this.items = res.data
