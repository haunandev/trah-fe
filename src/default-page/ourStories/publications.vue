<template>
  <div class="bg-white">
    ...
    <b-container fluid="md">
      <section class="our-stories-publications">
        ...
        <div class="row mt-5 mt-lg-10">
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div
              class="our_solution_category w-100"
              v-for="item in items"
              :key="item.id"
            >
              <div class="solution_cards_box">
                <div class="solution_card">
                  ...
                  <div class="solu_description">
                    ...
                    <a
                      target="_blank"
                      v-if="item.file_our_stories"
                      :href="item.file_our_stories.url"
                      class="read_more_btn"
                    >
                      Download
                    </a>
